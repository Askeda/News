...
<div id="header">
  <div id="top_login">
    <form action="LOGIN" method="get">
      <label> 登录名 </label>
      <input type="text" name="uname" value="" class="login_input" id="name" />
      <label> 密&#160;&#160;码 </label>
      <input type="password" name="pwd" value="" class="login_input" id="pas" />
      <input type="submit" class="login_sub" value="登录" id="sub"/>
